...
const startDate = _util.elt("input", {
  type: "datetime-local"
});
const deviceSelector = _util.elt("select", {}, _util.elt("option", {
  value: "177"
}, "Korčula 1"));
startDate.value = _momentDefault.default().subtract(1, "days").format("YYYY-MM-DDTHH:mm");
const endDate = _util.elt("input", {
  type: "datetime-local"
});
endDate.value = _momentDefault.default().format("YYYY-MM-DDTHH:mm");
const report = _util.elt("p", {
  style: "margin-bottom:0"
}, "");
const download = _util.elt("a", {
  style: "display:inline-block",
  href: "data:text/plain;charset=utf-8," + encodeURIComponent(""),
  download: "Mjerenja.csv"
}, "preuzmi");
const tbody = _util.elt("tbody", {});
const tbl = _util.elt("table", {}, // suppress 100%
...
}, _util.elt("label", {}, "Odaberi uređaj"), deviceSelector, _util.elt("label", {}, "Početni datum i vrijeme"), startDate, _util.elt("label", {}, "Završni datum i vrijeme"), endDate, report, download, tbl);
...
function deviceSelectorChanged() {
  const pressurePromise = fetch("https://gis.edc.hr/imagisth/threport/pressure_th_mt?device_id=eq." + deviceId);
  const flowPromise = fetch("https://gis.edc.hr/imagisth/threport/flow_th_mt_m3?device_id=eq." + deviceId);
...
function period(val) {
  ...
  if (_momentDefault.default(startDate.value) >= _momentDefault.default(endDate.value)) {
    r.report = "Početni datum i vrijeme moraju biti ranije.";
  } else {
    for (const value of val) {
      if (value.timestamp > _momentDefault.default(startDate.value) && value.timestamp < _momentDefault.default(endDate.value)) {
        r.values.push(value);
      }
    }
...
},{"moment":"5Hi32","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y","./util":"7eZGY"}],"5Hi32":[function(require,module,exports) {
var define;
// ! moment.js
// ! version : 2.29.1
...
},{}],"7eZGY":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}]},["3Imd1","5rkFb"], "5rkFb", "parcelRequiree76d")
