...
var deviceSelector = (0, _util.elt)("select", {});
var valuesSelector = (0, _util.elt)("select", {});
var fielset = (0, _util.elt)("fieldset", {}, (0, _util.elt)("label", {}, "Odaberi uređaj"), deviceSelector, (0, _util.elt)("label", {}, "Izmjereno"), valuesSelector);
...
deviceSelector.addEventListener("change", function (evt) {
  ...
  fetch("https://gis.edc.hr/imagisth/threport/pressure_th?device_id=eq." + deviceId).then(function (response) {
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        var i = _step2.value;
        console.log(i);
        valuesSelector.options.add(new Option(i.date_part + ":" + i.pressure));
      }
    } catch (err) {
      _iterator2.e(err);
    } finally {
...
},{"./util":"util.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
